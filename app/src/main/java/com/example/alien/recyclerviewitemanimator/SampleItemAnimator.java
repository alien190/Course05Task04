...
public class SampleItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder holder) {
        SpringAnimation mTranslationY;

        holder.itemView.setY(0);
        mTranslationY = new SpringAnimation(holder.itemView,
        ...
        mTranslationY.setSpring(springForceY);
        mTranslationY.start();
    ...
    public void onRemoveStarting(RecyclerView.ViewHolder item) {
        View animatedObject = item.itemView;

        int maxValue = animatedObject.getHeight() * 3;
        FlingAnimation flingY = new FlingAnimation(animatedObject, DynamicAnimation.TRANSLATION_Y);
